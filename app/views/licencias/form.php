        ...
        <form action="<?= APP_URL ?>/licencias/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2">
                <div class="form-group">
                    ...
                    <?php if (isset($docenteActual) && $docenteActual): ?>
                        <input type="text" class="form-control" value="<?= htmlspecialchars($docenteActual['nombres'] . ' ' . $docenteActual['apellidos']) ?>" readonly disabled>
                        <input type="hidden" name="docente_id" value="<?= $docenteActual['id'] ?>">
                    <?php else: ?>
